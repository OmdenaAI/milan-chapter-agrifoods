...
dest_dir='src/data/NASA data download code/data/test_data' 
#file path containing location of Italy lat and lang with city names
locations_file_path ='src/data/NASA data download code/it_locations.csv'
#file path for the parameter to dowanlod from NASA website, add or remove parameters from this file 
paramters_file_path = 'src/data/NASA data download code/params.csv'
...
class Process():
    def __init__(self):
        ...
        self.filename_template = "{dir}{loc_name}_Lat_{latitude}_Lon_{longitude}.json"

        self.messages = []
        self.times = {}
        

    def execute(self,dst_dir,locations_file_path,parameters_file_path,start_date,end_date):
        ...
        # for latitude, longitude in locations:
            ...
            filename = self.filename_template.format(dir=dst_dir,loc_name=loc_name,latitude=latitude, longitude=longitude)
