...
class GaussianProcess:
    ...
    def __init__(self, gauss_params):
        ...
        self.sigma = gauss_params['sigma']
        self.r_loc = gauss_params['r_loc']
        self.r_year = gauss_params['r_year']
        self.sigma_e = gauss_params['sigma_e']
        self.sigma_b = gauss_params['sigma_b']
