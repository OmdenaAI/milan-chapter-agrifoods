...
model1 = load_model('cereals_knn')
model2= load_model('fruits&nuts_knn')
model3 = load_model('grapes_olives_et')
model4 = load_model('fresh_veg_et')
model5 = load_model('industrial_crop_et')
